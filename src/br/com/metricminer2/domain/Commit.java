...
public class Commit {
	...
	public void addModification(String worktree, String oldPath, String newPath, ModificationType change, String diff, String sc) {
		Modification m = new Modification(worktree, oldPath, newPath, change, diff, sc);
		modifications.add(m);
